...
button.addEventListener("click", function () {
  let arr = [];
  function randGetName() {
    return jsonData
      .data.memes[(jsonData.data.memes.length * Math.random()) | 0];
  }

  arr.push(randGetName());

  document.getElementById("maintext").textContent = arr[0].name;
  document.getElementById("image").src = arr[0].url;
  document.getElementById("image").width = "500";
  document.getElementById("image").height = "500";
});

//  add hidden to elements before or delete in the function!! classlist.add()/.delete()
